...
setwd(getwd())
matches <- as.data.frame(read.csv('C:/Users/Fy16/Downloads/Cricket/IPL Matches 2008-2020.csv'))
deliveries <- as.data.frame(read.csv('C:/Users/Fy16/Downloads/Cricket/IPL Ball-by-Ball 2008-2020.csv'))
...
ui <- dashboardPage(
  ...
  dashboardSidebar( tags$style(HTML('.main-sidebar{width: 220px;}')),
                    sidebarMenu(
                      ...
                      menuItem("Source code", icon = icon("code"), href = "https://github.com/Rana-Ajay/STA_6233_Spring2022_IPL-Analysis/blob/main/IPL_Analysis.R")
                    )
  ),
  dashboardBody(
    tabItems(
